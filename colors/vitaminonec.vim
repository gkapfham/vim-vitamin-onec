...
" License:      MIT License
" Last Updated: Thu 01 Aug 2019 12:36:48 PM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi ALEErrorSignLineNr guifg=#d75f5f guibg=NONE guisp=NONE gui=bold cterm=bold
  hi ALEInfoSignLineNr guifg=#afaf5f guibg=NONE guisp=NONE gui=bold cterm=bold
  hi ALEWarningSignLineNr guifg=#afaf5f guibg=NONE guisp=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi! link ALEWarningSign String
  hi! link ALEErrorSign WarningMsg
  hi ALEErrorSignLineNr ctermfg=167 ctermbg=NONE cterm=bold
  hi ALEInfoSignLineNr ctermfg=143 ctermbg=NONE cterm=bold
  hi ALEWarningSignLineNr ctermfg=143 ctermbg=NONE cterm=bold
  hi! link gitmessengerHeader Identifier
  hi! link gitmessengerHash Comment
  hi! link gitmessengerHistory Constant
  hi! link gitmessengerPopupNormal CursorLine
...
if s:t_Co >= 8
  ...
  hi! link ALEWarningSign String
  hi! link ALEErrorSign WarningMsg
  hi ALEErrorSignLineNr ctermfg=DarkRed ctermbg=NONE cterm=bold
  hi ALEInfoSignLineNr ctermfg=DarkYellow ctermbg=NONE cterm=bold
  hi ALEWarningSignLineNr ctermfg=DarkYellow ctermbg=NONE cterm=bold
  hi! link gitmessengerHeader Identifier
  hi! link gitmessengerHash Comment
  hi! link gitmessengerHistory Constant
  hi! link gitmessengerPopupNormal CursorLine
