...
" License:      MIT License
" Last Updated: Wed 24 Aug 2022 04:54:43 PM EDT
...
hi LeapMatch guifg=#afaf5f guibg=NONE gui=bold,italic,underline cterm=bold,italic,underline
hi LeapLabelPrimary guifg=#d78700 guibg=NONE gui=bold,italic,underline cterm=bold,italic,underline
hi LeapLabelSecondary guifg=#5f8700 guibg=NONE gui=bold,italic,underline cterm=bold,italic,underline
hi LeapLabelSelected guifg=#d75f5f guibg=NONE gui=bold,italic,underline cterm=bold,italic,underline
...
if !s:italics
  ...
  hi LeapMatch gui=bold,underline cterm=bold,underline
  hi LeapLabelPrimary gui=bold,underline cterm=bold,underline
  hi LeapLabelSecondary gui=bold,underline cterm=bold,underline
  hi LeapLabelSelected gui=bold,underline cterm=bold,underline
endif
if has('nvim')
...
if s:t_Co >= 256
  ...
  hi LeapMatch ctermfg=143 ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelPrimary ctermfg=172 ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelSecondary ctermfg=64 ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelSelected ctermfg=167 ctermbg=NONE cterm=bold,italic,underline
  ...
  if !s:italics
    ...
    hi LeapMatch cterm=bold,underline
    hi LeapLabelPrimary cterm=bold,underline
    hi LeapLabelSecondary cterm=bold,underline
    hi LeapLabelSelected cterm=bold,underline
  endif
  if has('nvim')
    hi! link TermCursor Cursor
...
if s:t_Co >= 8
  ...
  hi LightspeedGreywash ctermfg=NONE ctermbg=NONE cterm=NONE
  hi LeapMatch ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelPrimary ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelSecondary ctermfg=DarkGreen ctermbg=NONE cterm=bold,italic,underline
  hi LeapLabelSelected ctermfg=DarkRed ctermbg=NONE cterm=bold,italic,underline
