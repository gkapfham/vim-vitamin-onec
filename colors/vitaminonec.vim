...
" License:      MIT License
" Last Updated: Mon 13 Jun 2022 03:41:06 PM EDT
...
if has('nvim')
  ...
  hi TermCursorNC guifg=#767676 guibg=NONE gui=underline cterm=underline
endif
...
if s:t_Co >= 256
  ...
  if has('nvim')
    ...
    hi TermCursorNC ctermfg=243 ctermbg=NONE cterm=underline
  endif
...
if s:t_Co >= 8
  ...
  if has('nvim')
    ...
    hi TermCursorNC ctermfg=Gray ctermbg=NONE cterm=underline
  endif
  unlet s:t_Co s:italics
  finish
endif
