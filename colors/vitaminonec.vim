...
" License:      MIT License
" Last Updated: Sat 24 Dec 2022 11:20:55 AM EST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1d', '#d75f5f', '#5f8700', '#afaf5f', '#87afd7', '#875f87', '#87af87', '#767676', '#303030', '#d75f5f', '#5f8700', '#d78700', '#87afd7', '#875f87', '#87af87', '#bcbcbc']
endif
if has('nvim')
...
hi DiffText guifg=#5f8700 guibg=#bcbcbc gui=bold,reverse cterm=bold,reverse
...
hi PmenuSel guifg=#bcbcbc guibg=#303030 gui=reverse cterm=reverse
...
hi StatusLine guifg=#1c1c1d guibg=#bcbcbc gui=reverse cterm=reverse
...
hi VisualNOS guifg=#bcbcbc guibg=#87afd7 gui=NONE cterm=NONE
...
hi Ignore guifg=#bcbcbc guibg=NONE gui=NONE cterm=NONE
...
hi CursorIM guifg=NONE guibg=#bcbcbc gui=NONE cterm=NONE
...
hi NormalMode guifg=#767676 guibg=#bcbcbc gui=reverse cterm=reverse
...
hi VisualMode guifg=#87afd7 guibg=#bcbcbc gui=reverse cterm=reverse
hi CommandMode guifg=#875f87 guibg=#bcbcbc gui=reverse cterm=reverse
...
hi CmpItemKind guifg=#bcbcbc guibg=NONE gui=NONE cterm=NONE
...
if has('nvim')
  ...
  hi TermCursorNC guifg=#bcbcbc guibg=#767676 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=64 ctermbg=250 cterm=bold,reverse
  ...
  hi PmenuSel ctermfg=250 ctermbg=236 cterm=reverse
  ...
  hi StatusLine ctermfg=234 ctermbg=250 cterm=reverse
  ...
  hi VisualNOS ctermfg=250 ctermbg=110 cterm=NONE
  ...
  hi NormalMode ctermfg=243 ctermbg=250 cterm=reverse
  hi InsertMode ctermfg=64 ctermbg=234 cterm=reverse
  hi ReplaceMode ctermfg=143 ctermbg=234 cterm=reverse
  hi VisualMode ctermfg=110 ctermbg=250 cterm=reverse
  hi CommandMode ctermfg=96 ctermbg=250 cterm=reverse
  hi! link qfFileName Directory
  ...
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=250 ctermbg=243 cterm=NONE
...
" Color: brightwhite          rgb(188, 188, 188)   250        Gray
