...
" License:      MIT License
" Last Updated: Sun 05 Dec 2021 06:28:31 PM EST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi ErrorMsgMenu guifg=#d75f5f guibg=NONE gui=NONE cterm=NONE
  ...
  hi! link LspDiagnosticsError ErrorMsgMenu
  hi! link LspDiagnosticsWarning Conceal
  hi! link LspDiagnosticsInformation String
  hi! link LspDiagnosticsHint String
  hi! link LspDiagnosticsDefaultError ErrorMsgMenu
  hi! link LspDiagnosticsVirtualTextError ErrorMsgMenu
  ...
  hi LightspeedLabel guifg=#d78700 guibg=NONE gui=bold,italic cterm=bold,italic
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant guifg=#5f8700 guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedLabelDistantOverlapped guifg=#5f8700 guibg=NONE gui=bold,underline cterm=bold,underline
  hi LightspeedShortcut guifg=#afaf5f guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedShortcutOverlapped guifg=#afaf5f guibg=NONE gui=bold,underline cterm=bold,underline
  hi LightspeedShortcut guifg=#875f87 guibg=NONE gui=bold,italic cterm=bold,italic
  ...
  hi LightspeedOneCharMatch guifg=#d78700 guibg=NONE gui=bold,italic cterm=bold,italic
  ...
  if !s:italics
    ...
    hi LightspeedLabel gui=bold cterm=bold
    hi LightspeedLabelDistant gui=bold cterm=bold
    hi LightspeedShortcut gui=bold cterm=bold
    hi LightspeedShortcut gui=bold cterm=bold
    hi LightspeedUnlabeledMatch gui=bold cterm=bold
    hi LightspeedOneCharMatch gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi ErrorMsgMenu ctermfg=167 ctermbg=NONE cterm=NONE
  ...
  hi! link LspDiagnosticsFloatingHint Pmenu
  hi! link LspSignatureActiveParameter Pmenu
  hi LightspeedLabel ctermfg=172 ctermbg=NONE cterm=bold,italic
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant ctermfg=64 ctermbg=NONE cterm=bold,italic
  hi LightspeedLabelDistantOverlapped ctermfg=64 ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcut ctermfg=143 ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcutOverlapped ctermfg=143 ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcut ctermfg=96 ctermbg=NONE cterm=bold,italic
  ...
  hi LightspeedOneCharMatch ctermfg=172 ctermbg=NONE cterm=bold,italic
  ...
  if !s:italics
    ...
    hi LightspeedLabel cterm=bold
    hi LightspeedLabelDistant cterm=bold
    hi LightspeedShortcut cterm=bold
    hi LightspeedShortcut cterm=bold
    hi LightspeedUnlabeledMatch cterm=bold
    hi LightspeedOneCharMatch cterm=bold
...
if s:t_Co >= 8
  ...
  hi ErrorMsgMenu ctermfg=DarkRed ctermbg=NONE cterm=NONE
  ...
  hi! link LspDiagnosticsFloatingHint Pmenu
  hi! link LspSignatureActiveParameter Pmenu
  hi LightspeedLabel ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant ctermfg=DarkGreen ctermbg=NONE cterm=bold,italic
  hi LightspeedLabelDistantOverlapped ctermfg=DarkGreen ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcut ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcutOverlapped ctermfg=DarkYellow ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcut ctermfg=DarkMagenta ctermbg=NONE cterm=bold,italic
  ...
  hi LightspeedOneCharMatch ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
