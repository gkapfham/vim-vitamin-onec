...
" License:      MIT License
" Last Updated: Mon 13 Jun 2022 02:33:28 PM EDT
...
if has('nvim')
  ...
  hi! link TermCursor CursorIM
  hi TermCursorNC guifg=NONE guibg=#a8a8a8 gui=reverse cterm=reverse
endif
...
if s:t_Co >= 256
  ...
  if has('nvim')
    ...
    hi! link TermCursor CursorIM
    hi TermCursorNC ctermfg=NONE ctermbg=248 cterm=reverse
  endif
...
if s:t_Co >= 8
  ...
  if has('nvim')
    ...
    hi! link TermCursor CursorIM
    hi TermCursorNC ctermfg=NONE ctermbg=Gray cterm=reverse
  endif
  unlet s:t_Co s:italics
  finish
endif
