...
" License:      MIT License
" Last Updated: Tue 27 Jul 2021 04:56:52 PM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi LightspeedLabel guifg=#d78700 guibg=NONE gui=bold,underline cterm=bold,underline
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant guifg=#5f8700 guibg=NONE gui=bold cterm=bold
  hi LightspeedLabelDistantOverlapped guifg=#5f8700 guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedShortcut guifg=#afaf5f guibg=NONE gui=bold,underline cterm=bold,underline
  hi LightspeedShortcutOverlapped guifg=#afaf5f guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedShortcut guifg=#875f87 guibg=NONE gui=bold,underline cterm=bold,underline
  hi LightspeeddShortcutOverlapped guifg=#875f87 guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedMaskedChar guifg=#87af87 guibg=NONE gui=bold,underline cterm=bold,underline
  hi LightspeedUnlabeledMatch guifg=#87af87 guibg=NONE gui=bold,italic cterm=bold,italic
  hi LightspeedOneCharMatch guifg=#d78700 guibg=NONE gui=bold,underline cterm=bold,underline
  ...
  if !s:italics
    ...
    hi LightspeedLabelDistantOverlapped gui=bold cterm=bold
    hi LightspeedShortcutOverlapped gui=bold cterm=bold
    hi LightspeeddShortcutOverlapped gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi! link LspDiagnosticsFloatingHint Pmenu
  hi! link LspSignatureActiveParameter Pmenu
  hi LightspeedLabel ctermfg=172 ctermbg=NONE cterm=bold,underline
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant ctermfg=64 ctermbg=NONE cterm=bold
  hi LightspeedLabelDistantOverlapped ctermfg=64 ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcut ctermfg=143 ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcutOverlapped ctermfg=143 ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcut ctermfg=96 ctermbg=NONE cterm=bold,underline
  hi LightspeeddShortcutOverlapped ctermfg=96 ctermbg=NONE cterm=bold,italic
  hi LightspeedMaskedChar ctermfg=108 ctermbg=NONE cterm=bold,underline
  hi LightspeedUnlabeledMatch ctermfg=108 ctermbg=NONE cterm=bold,italic
  hi LightspeedOneCharMatch ctermfg=172 ctermbg=NONE cterm=bold,underline
  ...
  if !s:italics
    ...
    hi LightspeedLabelDistantOverlapped cterm=bold
    hi LightspeedShortcutOverlapped cterm=bold
    hi LightspeeddShortcutOverlapped cterm=bold
...
if s:t_Co >= 8
  ...
  hi! link LspDiagnosticsFloatingHint Pmenu
  hi! link LspSignatureActiveParameter Pmenu
  hi LightspeedLabel ctermfg=DarkYellow ctermbg=NONE cterm=bold,underline
  hi! link LightspeedLabelOverlapped Todo
  hi LightspeedLabelDistant ctermfg=DarkGreen ctermbg=NONE cterm=bold
  hi LightspeedLabelDistantOverlapped ctermfg=DarkGreen ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcut ctermfg=DarkYellow ctermbg=NONE cterm=bold,underline
  hi LightspeedShortcutOverlapped ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  hi LightspeedShortcut ctermfg=DarkMagenta ctermbg=NONE cterm=bold,underline
  hi LightspeeddShortcutOverlapped ctermfg=DarkMagenta ctermbg=NONE cterm=bold,italic
  hi LightspeedMaskedChar ctermfg=DarkCyan ctermbg=NONE cterm=bold,underline
  hi LightspeedUnlabeledMatch ctermfg=DarkCyan ctermbg=NONE cterm=bold,italic
  hi LightspeedOneCharMatch ctermfg=DarkYellow ctermbg=NONE cterm=bold,underline
