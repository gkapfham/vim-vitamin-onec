...
" License:      MIT License
" Last Updated: Mon 13 Jun 2022 03:22:17 PM EDT
...
if has('nvim')
  ...
  hi TermCursorNC guifg=NONE guibg=#767676 gui=NONE cterm=NONE
endif
...
if s:t_Co >= 256
  ...
  if has('nvim')
    ...
    hi TermCursorNC ctermfg=NONE ctermbg=243 cterm=NONE
  endif
...
if s:t_Co >= 8
  ...
  if has('nvim')
    ...
    hi TermCursorNC ctermfg=NONE ctermbg=Gray cterm=NONE
  endif
  unlet s:t_Co s:italics
  finish
endif
