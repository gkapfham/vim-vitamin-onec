...
" License:      MIT License
" Last Updated: Sat 24 Dec 2022 11:24:08 AM EST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1d', '#d75f5f', '#5f8700', '#afaf5f', '#87afd7', '#875f87', '#87af87', '#767676', '#303030', '#d75f5f', '#5f8700', '#d78700', '#87afd7', '#875f87', '#87af87', '#b2b2b2']
endif
if has('nvim')
...
hi Normal guifg=#b2b2b2 guibg=NONE gui=NONE cterm=NONE
...
hi Terminal guifg=#b2b2b2 guibg=NONE gui=NONE cterm=NONE
hi Normal guifg=#b2b2b2 guibg=NONE gui=NONE cterm=NONE
hi CursorLineNr guifg=#5f8700 guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=#767676 guibg=NONE gui=NONE cterm=NONE
hi LineNr guifg=#767676 guibg=NONE gui=NONE cterm=NONE
...
hi DiffText guifg=#5f8700 guibg=#b2b2b2 gui=bold,reverse cterm=bold,reverse
...
hi Pmenu guifg=#b2b2b2 guibg=#303030 gui=NONE cterm=NONE
hi PmenuSbar guifg=#303030 guibg=#303030 gui=NONE cterm=NONE
hi PmenuSel guifg=#b2b2b2 guibg=#303030 gui=reverse cterm=reverse
...
hi StatusLine guifg=#1c1c1d guibg=#b2b2b2 gui=reverse cterm=reverse
...
hi VisualNOS guifg=#b2b2b2 guibg=#87afd7 gui=NONE cterm=NONE
...
hi Ignore guifg=#b2b2b2 guibg=NONE gui=NONE cterm=NONE
...
hi CursorIM guifg=NONE guibg=#b2b2b2 gui=NONE cterm=NONE
...
hi NormalMode guifg=#767676 guibg=#b2b2b2 gui=reverse cterm=reverse
...
hi VisualMode guifg=#87afd7 guibg=#b2b2b2 gui=reverse cterm=reverse
hi CommandMode guifg=#875f87 guibg=#b2b2b2 gui=reverse cterm=reverse
...
hi CmpItemKind guifg=#b2b2b2 guibg=NONE gui=NONE cterm=NONE
...
if has('nvim')
  ...
  hi TermCursorNC guifg=#b2b2b2 guibg=#767676 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=64 ctermbg=249 cterm=bold,reverse
  ...
  hi PmenuSel ctermfg=249 ctermbg=236 cterm=reverse
  ...
  hi StatusLine ctermfg=234 ctermbg=249 cterm=reverse
  ...
  hi VisualNOS ctermfg=249 ctermbg=110 cterm=NONE
  ...
  hi CursorIM ctermfg=NONE ctermbg=249 cterm=NONE
  ...
  hi NormalMode ctermfg=243 ctermbg=249 cterm=reverse
  hi InsertMode ctermfg=64 ctermbg=234 cterm=reverse
  hi ReplaceMode ctermfg=143 ctermbg=234 cterm=reverse
  hi VisualMode ctermfg=110 ctermbg=249 cterm=reverse
  hi CommandMode ctermfg=96 ctermbg=249 cterm=reverse
  hi! link qfFileName Directory
  ...
  hi CmpItemKind ctermfg=249 ctermbg=NONE cterm=NONE
  ...
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=249 ctermbg=243 cterm=NONE
...
" Color: brightwhite          rgb(178, 178, 178)   249        Gray
