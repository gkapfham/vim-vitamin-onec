...
" License:      MIT License
" Last Updated: Wed 15 Nov 2023 01:04:44 PM EST
...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'vitaminonec_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1d', '#d75f5f', '#5f8700', '#afaf5f', '#87afd7', '#875f87', '#87af87', '#767676', '#303030', '#d75f5f', '#5f8700', '#d78700', '#87afd7', '#875f87', '#87af87', '#a8a8af']
endif
if has('nvim')
  ...
  let g:terminal_color_15 = '#a8a8af'
endif
hi Normal guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
...
hi Terminal guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
hi Normal guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
hi CursorLineNr guifg=#5f8700 guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=#767676 guibg=NONE gui=NONE cterm=NONE
hi LineNr guifg=#767676 guibg=NONE gui=NONE cterm=NONE
...
hi Cursor guifg=#afaf5f guibg=NONE gui=bold,italic cterm=bold,italic
...
hi DiffText guifg=#5f8700 guibg=#a8a8af gui=bold,reverse cterm=bold,reverse
...
hi NonText guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
hi Pmenu guifg=#a8a8af guibg=#303030 gui=NONE cterm=NONE
hi PmenuSbar guifg=#303030 guibg=#303030 gui=NONE cterm=NONE
hi PmenuSel guifg=#a8a8af guibg=#303030 gui=reverse cterm=reverse
...
hi StatusLine guifg=#1c1c1d guibg=#a8a8af gui=reverse cterm=reverse
...
hi Ignore guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
hi Include guifg=#87af87 guibg=NONE gui=NONE cterm=NONE
...
hi Special guifg=#afaf5f guibg=NONE gui=bold cterm=bold
...
hi String.documentation guifg=#afaf5f guibg=NONE gui=italic cterm=italic
...
hi CursorIM guifg=NONE guibg=#a8a8af gui=NONE cterm=NONE
...
hi pythonBuiltin guifg=#875f87 guibg=NONE gui=NONE cterm=NONE
...
hi NormalMode guifg=#767676 guibg=#a8a8af gui=reverse cterm=reverse
...
hi VisualMode guifg=#87afd7 guibg=#a8a8af gui=reverse cterm=reverse
hi CommandMode guifg=#875f87 guibg=#a8a8af gui=reverse cterm=reverse
...
hi LeapMatch guifg=#d78700 guibg=NONE gui=bold,italic cterm=bold,italic
hi LeapLabelPrimary guifg=#d78700 guibg=NONE gui=bold,italic cterm=bold,italic
hi LeapLabelSecondary guifg=#5f8700 guibg=NONE gui=bold,italic cterm=bold,italic
hi LeapLabelSelected guifg=#d75f5f guibg=NONE gui=bold,italic cterm=bold,italic
hi CmpItemKind guifg=#a8a8af guibg=NONE gui=NONE cterm=NONE
hi TreesitterContext guifg=NONE guibg=#1c1c1d gui=NONE cterm=NONE
hi WinBar guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi! link NeoTreeGitAdded Identifier
hi! link NeoTreeGitModified Identifier
hi! link NeoTreeGitDeleted Identifier
hi! link NeoTreeGitRenamed Identifier
hi! link NeoTreeGitUntracked Character
hi! link NeoTreeGitIgnored Character
hi! link NeoTreeGitUnstaged Character
hi! link NeoTreeGitStaged Character
hi! link NeoTreeGitConflict Character
hi! link NotifyERRORBorder ErrorMsg
hi! link NotifyWARNBorder Conceal
hi! link NotifyINFOBorder String
hi! link NotifyDEBUGBorder Debug
hi! link NotifyTRACEBorder Normal
hi! link NotifyERRORIcon ErrorMsg
hi! link NotifyWARNIcon Conceal
hi! link NotifyINFOIcon String
hi! link NotifyDEBUGIcon Debug
hi! link NotifyTRACEIcon Normal
hi! link NotifyERRORTitle ErrorMsg
hi! link NotifyWARNTitle Conceal
hi! link NotifyINFOTitle String
hi! link NotifyDEBUGTitle Debug
hi! link NotifyTRACETitle Normal
if !s:italics
  hi Cursor gui=bold cterm=bold
  hi Folded gui=NONE cterm=NONE
  hi Comment gui=NONE cterm=NONE
  hi String.documentation gui=NONE cterm=NONE
  ...
  hi LeapMatch gui=bold cterm=bold
  hi LeapLabelPrimary gui=bold cterm=bold
  hi LeapLabelSecondary gui=bold cterm=bold
  hi LeapLabelSelected gui=bold cterm=bold
endif
if has('nvim')
  hi! link TermCursor Cursor
  hi TermCursorNC guifg=#a8a8af guibg=#767676 gui=NONE cterm=NONE
  hi TermCursor guifg=NONE guibg=#767676 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Cursor ctermfg=143 ctermbg=NONE cterm=bold,italic
  ...
  hi Special ctermfg=143 ctermbg=NONE cterm=bold
  ...
  hi String.documentation ctermfg=143 ctermbg=NONE cterm=italic
  ...
  hi pythonBuiltin ctermfg=96 ctermbg=NONE cterm=NONE
  ...
  hi LeapMatch ctermfg=172 ctermbg=NONE cterm=bold,italic
  hi LeapLabelPrimary ctermfg=172 ctermbg=NONE cterm=bold,italic
  hi LeapLabelSecondary ctermfg=64 ctermbg=NONE cterm=bold,italic
  hi LeapLabelSelected ctermfg=167 ctermbg=NONE cterm=bold,italic
  hi CmpItemKind ctermfg=248 ctermbg=NONE cterm=NONE
  hi TreesitterContext ctermfg=NONE ctermbg=234 cterm=NONE
  ...
  if !s:italics
    ...
    hi String.documentation cterm=NONE
    ...
    hi LeapMatch cterm=bold
    hi LeapLabelPrimary cterm=bold
    hi LeapLabelSecondary cterm=bold
    hi LeapLabelSelected cterm=bold
  endif
  if has('nvim')
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=248 ctermbg=243 cterm=NONE
    hi TermCursor ctermfg=NONE ctermbg=243 cterm=NONE
...
if s:t_Co >= 8
  ...
  hi Cursor ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  ...
  hi Boolean ctermfg=DarkMagenta ctermbg=NONE cterm=NONE
  ...
  hi String.documentation ctermfg=DarkYellow ctermbg=NONE cterm=italic
  ...
  hi semshiUnresolved ctermfg=NONE ctermbg=NONE cterm=underline
  hi semshiSelected ctermfg=NONE ctermbg=NONE cterm=bold,underline
  hi pythonBuiltin ctermfg=DarkMagenta ctermbg=NONE cterm=NONE
  ...
  hi LightspeedGreywash ctermfg=NONE ctermbg=NONE cterm=NONE
  hi LeapMatch ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  hi LeapLabelPrimary ctermfg=DarkYellow ctermbg=NONE cterm=bold,italic
  hi LeapLabelSecondary ctermfg=DarkGreen ctermbg=NONE cterm=bold,italic
  hi LeapLabelSelected ctermfg=DarkRed ctermbg=NONE cterm=bold,italic
  hi CmpItemKind ctermfg=Gray ctermbg=NONE cterm=NONE
  hi TreesitterContext ctermfg=NONE ctermbg=Black cterm=NONE
  hi WinBar ctermfg=NONE ctermbg=NONE cterm=NONE
  hi! link NeoTreeGitAdded Identifier
  hi! link NeoTreeGitModified Identifier
  hi! link NeoTreeGitDeleted Identifier
  ...
  if has('nvim')
    ...
    hi TermCursor ctermfg=NONE ctermbg=Gray cterm=NONE
    hi TermCursorNC ctermfg=NONE ctermbg=NONE cterm=NONE
  endif
  unlet s:t_Co s:italics
  finish
...
" Color: brightwhite          rgb(168, 168, 175)   248        Gray
